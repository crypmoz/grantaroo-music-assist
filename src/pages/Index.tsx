            ...
            once: true
                ...
                <div className="container mx-auto px-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {/* Success Story Cards */}
                    {[1, 2, 3].map(item => <motion.div key={item} initial={{
                  opacity: 0,
                  y: 20
                }} whileInView={{
                  opacity: 1,
                  ...
                  once: true
                        ...
                        <img src={`/lovable-uploads/31de3fac-c732-4f53-bb13-86bde610ee0d.png`} alt={`Success story ${item}`} className="w-full h-48 object-cover" />
                        <div className="p-6">
