...
export const GrantAssistantTabs = () => {
  ...
  return (
    <Card className="h-[70vh] shadow-lg border-primary/20 overflow-hidden rounded-xl flex flex-col">
      <div className="p-4 border-b bg-muted/30 backdrop-blur-sm flex-shrink-0">
