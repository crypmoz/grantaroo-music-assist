...
export const HeroSection = () => {
  return <section className="relative bg-gray-900 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img src="/lovable-uploads/35ab546c-bb47-4005-90f0-4bcf30b2aa99.png" alt="Musician in recording studio" className="w-full h-full object-cover opacity-90" />
      ...
      <div className="container mx-auto px-4 py-20 md:py-28 relative z-10">
        <div className="max-w-2xl">
          ...
          delay: 0.4
            ...
            <Button size="lg" variant="outline" className="text-white border-white bg-blue-700 hover:bg-blue-600">
              Learn more
            </Button>
          </motion.div>
        </div>
